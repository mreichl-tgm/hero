...
\subsubsection{\texttt{/Task/} Unity Roguelike Tutorial \small{(D R T W)}}
In order to get acquainted to the Unity engine, all members of the team have to complete the \hyperref{https://unity3d.com/learn/tutorials/projects/2d-roguelike-tutorial}{Roguelike Tutorial} by Unity.
